    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          ...
          <div id="chatbox" class="card-body bg-secondary">
            <div
        ...
        <div class="card">
          ...
          <div id="user-online" class="card-body bg-secondary">
            <ul class="list-group">
              ...
              >
                <img
                  src="https://a1cf74336522e87f135f-2f21ace9a6cf0052456644b80fa06d4f.ssl.cf2.rackcdn.com/images/characters_opt/p-mr-robot-rami-malek.jpg"
